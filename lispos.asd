...
(defsystem "lispos"
  ...
  :components ((:file "compiler/cross")
               ...
               (:file "compiler/backend/ppc64le/ppc64le")
               (:file "compiler/backend/ppc64le/target")
               (:file "compiler/backend/ppc64le/codegen")
               (:file "compiler/backend/ppc64le/builtin")
               ...
               (:file "tools/cold-generator2/ppc64le")))
